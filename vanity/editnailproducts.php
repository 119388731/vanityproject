    ...
    <form class="form-default" action="nailproducts.php" method="POST"  >
        ...
        if (isset($_POST['submit'])) {
            ...
            $nail_products = $_POST['nail_products'];
                ...
                $result   = mysqli_query($con, "UPDATE nail_products SET customer='$customer', staff='$staff', polish='$polish', gel_polish='$gel_polish', tip='$tip', acrylic_powder='$acrylic_powder', 
                nail_treatment='$nail_treatment', nail_products='$nail_products'");

                // check if user data inserted successfully.
                if ($result) {
                    echo "<br/><br/> Nail products updated.";
                } else {
