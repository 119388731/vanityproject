    ...
    <form class="form-default" action="makeupproducts.php" method="POST"  >
        ...
        if (isset($_POST['submit'])) {
            ...
            $makeup_other = $_POST['makeup_other'];
                ...
                $result   = mysqli_query($con, "INSERT INTO makeup_products(customer, staff, primer, foundation, powder, contour, concealer, blush, eyeshadow, liner, lashes, lipstick, lipliner, lipgloss, makeup_other) 
                VALUES('$customer', '$staff', '$primer', '$foundation', '$powder', '$contour', '$concealer', '$blush, '$eyeshadow', '$liner', '$lashes', '$lipstick', '$lipliner', '$lipgloss', '$makeup_other')");
