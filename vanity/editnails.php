...
<main class="login-body" data-vide-bg="assets/img/login-bg.mp4">
    <!-- Login Admin -->
    <div class="form">
    <form class="form-default" action="editnails.php" method="POST"  >
        ...
        if (isset($_POST['update'])) {
            ...
            $nail_notes = $_POST['nail_notes'];
                ...
                $result   = mysqli_query($con, "UPDATE nail_pref SET nail_length='$nail_length', nail_desc='$nail_desc', nail_notes='$nail_notes' WHERE email='$email'");

                // check if user data inserted successfully.
                if ($result) {
                    echo "<br/><br/> Nail preferences updated.";
                } else {
