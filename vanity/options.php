                                ...
                                <div class="main-menu d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">                                                                                          
                                            ...
                                            <li><a href="eyes.php">Nails</a>
                                                <ul class="submenu">
                                                    <li><a href="nails.php">Nail Health</a></li>
                                                    <li><a href="nailart.php">Nail Art</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="face.php">Beauty</a>
                                                <ul class="submenu">
                                                    <li><a href="beauty.php">Skin</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Options</h1>
                                    <!-- breadcrumb Start-->
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                ...
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="nails.php">Nail Health</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                ...
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="nailart.php">Nail Art</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                ...
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="beauty.php">Beauty</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p>Make your services simplier.</p>
                                        <p> FYP by Emma Crowley - 119388731 from UCC </p>
                                    </div>
                                </div>
                                <!-- social -->
                                <div class="footer-social">
                                    <a href="https://github.com/119388731"><i class="fab fa-git"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
